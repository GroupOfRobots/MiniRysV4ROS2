...
# Form implementation generated from reading ui file 'RysRemoteMainWindow.ui'
#
...
class Ui_RysRemoteMainWindow(object):
    def setupUi(self, RysRemoteMainWindow):
        ...
        RysRemoteMainWindow.resize(593, 571)
        ...
        self.rollDial.setNotchTarget(0.0)
        ...
        self.throttleComboBox.setEnabled(True)
        ...
        self.rotationComboBox.setEnabled(True)
        ...
        self.menubar = QtWidgets.QMenuBar(RysRemoteMainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 593, 19))
        self.menubar.setObjectName("menubar")
        RysRemoteMainWindow.setMenuBar(self.menubar)
