...
class RosBridge(QThread):
	...
	def regulatorSettingsSetRequested(self, parameters):
		...
		request.pid_angular_velocity_factor = parameters['pidSpeedKp']
		request.pid_speed_kp = parameters['pidSpeedKi']
		request.pid_speed_ki = parameters['pidSpeedKd']
		request.pid_speed_kd = parameters['pidAngleKp']
